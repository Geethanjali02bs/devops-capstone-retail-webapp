...
Replace `geethanjali02` with your Docker Hub username.

### Frontend
```bash
docker build -t geethanjali02/novacart-frontend:v1 ./frontend
docker tag geethanjali02/novacart-frontend:v1 geethanjali02/novacart-frontend:latest
docker push geethanjali02/novacart-frontend:v1
docker push geethanjali02/novacart-frontend:latest
```

### Product Service
```bash
docker build -t geethanjali02/novacart-product-service:v1 ./product-service
docker tag geethanjali02/novacart-product-service:v1 geethanjali02/novacart-product-service:latest
docker push geethanjali02/novacart-product-service:v1
docker push geethanjali02/novacart-product-service:latest
```

### Cart Service
```bash
docker build -t geethanjali02/novacart-cart-service:v1 ./cart-service
docker tag geethanjali02/novacart-cart-service:v1 geethanjali02/novacart-cart-service:latest
docker push geethanjali02/novacart-cart-service:v1
docker push geethanjali02/novacart-cart-service:latest
```
...
Before applying manifests, update image names in `k8s/*.yaml` from `geethanjali02/...` to your Docker Hub username.
